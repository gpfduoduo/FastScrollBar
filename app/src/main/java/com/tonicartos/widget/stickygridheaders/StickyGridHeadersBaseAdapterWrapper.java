...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter
{
    ...
    public StickyGridHeadersBaseAdapterWrapper(Context context,
            StickyGridHeadersGridView gridView, StickyGridHeadersBaseAdapter delegate)
    {
        mContext = context;
        mDelegate = delegate;
        mGridView = gridView;
    ...
    public int getCount()
    {
        ...
        for (int i = 0; i < numHeaders; i++)
        {
            ...
            // group.
            mCount += mDelegate.getCountForHeader(i) + unFilledSpacesInHeaderGroup(i)
                + mNumColumns;
        }
        mCounted = true;
        return mCount;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (adapterPosition.mPosition == POSITION_HEADER)
        {
            HeaderFillerView v = getHeaderFillerView(adapterPosition.mHeader, convertView,
                parent);
        ...
        {
            convertView = mDelegate.getView(adapterPosition.mPosition, convertView,
                parent);
    ...
    protected View getHeaderView(int position, View convertView, ViewGroup parent)
    {
        ...
        return mDelegate.getHeaderView(translatePosition(position).mHeader, convertView,
            parent);
    }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
        {
            ...
            if (v.getVisibility() != View.GONE)
            {
                int heightSpec = getChildMeasureSpec(
                    ...
                    params.height);
                int widthSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(
                    mGridView.getWidth(), MeasureSpec.EXACTLY), 0, params.width);
