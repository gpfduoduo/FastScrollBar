 ...
 * 
 * The is a second interface {@link StickyGridHeadersBaseAdapter}.
 * 
 * @author Tonic Artos
 */
public interface StickyGridHeadersSimpleAdapter extends ListAdapter
{
     ...
     * layout file.
     * 
     * @param position The position of the header within the adapter's header
     *            data set.
