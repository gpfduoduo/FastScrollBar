...
public class ImageAdapter extends CustomAdapter<GridItem>
        implements AbsListView.OnScrollListener, StickyGridHeadersSimpleAdapter {
    ...
    public ImageAdapter(AbsListView view, Context context, int resLayoutId, List<GridItem> list) {
    ...
    @Override public void convert(ViewHolder viewHolder, GridItem gridItem) {
        ...
        if (!mIsInit) {
            ImageLoader.getInstance().loadImage(path, mImageView);
        }
    }
    ...
    @Override public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (mOnCustomScrollListener != null) {
            mOnCustomScrollListener.onScrollStateChanged(view, scrollState);
        }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (mOnCustomScrollListener != null) {
            mOnCustomScrollListener.onCustomScroll(view, firstVisibleItem, visibleItemCount,
                    totalItemCount);
        }
    }
    ...
    public void onScrollUp() {
        if (mScrollDirectionListener != null) mScrollDirectionListener.onScrollUp();
    }


    public void onScrollDown() {
        if (mScrollDirectionListener != null) mScrollDirectionListener.onScrollDown();
    }


    public void loadImage(int start, int end) {
        for (int i = start; i < mEndIndex; i++) {
            int realIndex = mStickyGridHeadersGridView.translatePosition(i);
            ...
            ImageLoader.getInstance().loadImage(path, img);
        }
    }
